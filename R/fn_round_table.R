...
#'
#' @return A data frame with specified numeric values rounded according to the parameters.
#'
#' @examples
        ...
        if (precision_matrix[r, c] > 0) {
          ...
          if (is.numeric(data[[c]]) ||
            ...
            if (is.na(value)) {
              ...
              threshold_string <- paste0("<", sprintf(format_string, 1 / (10^decimals)))

              if (round(num_value, decimals) == 0) {
                data[[c]][r] <- threshold_string
              } else {
                data[[c]][r] <- sprintf(format_string, round(num_value, decimals))
              }
            }
          }
        }
              ...
              if (is.numeric(data[[c]]) ||
                ...
                if (is.na(value)) {
                  ...
                  if (round(num_value, decimals) == 0) {
                    ...
                    data[[c]][idx] <- sprintf(format_string,
                                              round(num_value, decimals))
                  }
                }
              }
            }
              ...
              for (r in 1:nrow(data)) {
                ...
                if (is.na(value)) {
                  ...
                  if (round(num_value, decimals) == 0) {
                    ...
                    data[[idx]][r] <- sprintf(format_string,
                                              round(num_value, decimals))
                  }
                }
              }
